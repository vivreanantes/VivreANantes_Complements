public abstract class Abstract_ConvertData {
	...
	protected String tranlateHoraires(String horaires) {
		return horaires
				...
				.replace(
						"D�p�t d'objets r�utilisables : lundi-samedi de 9h à 12h Boutique solidaire : le samedi de 10h à 18h", //
						"0101-3112_lu+ma+me+je+ve_12h00-14h00")
				// OK COMMENTAIRE
				.replace(
						"D�p�ts des dons : Mardi, mercredi, vendredi et le samedi de 9h30 à 11h30 et de 13h30 à 16h30. Salle de vente : Le mercredi de 13h30 à 17h30 et le samedi de 9h30 à 11h30 et de 13h30 à 17h30.", //
						"0101-3112_lu+ma+me+je+ve_12h00-14h00")
				.replace(
				...
				.replace(
						...
						"0101-3112_lu+ma+me+je+ve_12h00-14h00")
				.replace(
						"La boutique est ouverte tous les mercredi et samedi de 9h30 à 12h et de 14h à 16h45. Chacun peut �galement venir y d�poser les objets encore utilisables, aux m�mes jours et heures d�ouverture.", //
						"0101-3112_lu+ma+me+je+ve_12h00-14h00")
				.replace(
				...
				.replace(
						"Lundi de 14h à 18h, mercredi de 08h30 à 12h30, et samedi de 09h à 12h30 et de 14h à 18h. Ferm� les 1er janvier, 1er mai et 25 d�cembre.", //
				...
				.replace(
						"Lundi de 8h30 à 12h30, mercredi de 14h à 18h et samedi de 9h à 12h30 et de 14h à 18h. Ferm� les 1er janvier, 1er mai et 25 d�cembre.", //
				...
				.replace(
						"Lundi et vendredi de 14h à 18h, du mardi au jeudi de 9h à 12h, et le samedi de 9h à 12h30 et de 14h à 18h30. Ferm� les 1er janvier, 1er mai et 25 d�cembre.", //
				...
				.replace(
						...
						"0101-3112_me+sa_09h30-12h00+14h00-16h45") //
				.replace(
						"Ouvert tous les jours de 10h à  18h, dimanche compris (sauf jours fériés)", //
						"0101-3112_lu+ma+me+je+ve+sa+di_10h00-18h00,sauf_ferie") //
				.replace(
						"Pour effectuer vos dépôts : du lundi au samedi de 8h00 à  11h30 et de 14h à  17h30", //
						"0101-3112_lu+ma+me+je+ve+sa_08h00-11h30+14h00-17h30") //
				.replace(
						"Ouvert Lundi, Mardi, Mercredi, Vendredi et Samedi de 10h à  18h (sauf jours fériés)", //
						"0101-3112_lu+ma+me+je+ve+sa_10h00-18h00,sauf_ferie") //
				.replace(
						" Été (Du 1er avril au 30 septembre) : Lundi au Samedi de 9h à 19h. Dimanche de 9h à 12h15. Hiver (du 1er octobre au 31 mars) : Lundi au Samedi de 9h à 18h. Dimanche de 9h à 12h15. Fermeture les jours fériés.", //
						"0104-3008_lu+ma+me+je+ve+sa_09h00-19h00,0104-3008_di_09h00-12h15,0101-3103+0109-3112_lu+ma+me+je+ve+sa_09h00-18h00,0101-3103+0109-3112_di_09h00-12h15,sauf_ferie") //
				.replace(
						"Ouvert du Lundi au Samedi de 10h à  18h et le Dimanche de 8h30 à  12h (sauf jours fériés)", //
						"0101-3112_lu+ma+me+je+ve+sa_10h00-18h00,0101-3112_di_08h30-12h00,sauf_ferie") //
				.replace(
						"Ouvert Lundi et Mercredi de 14h à  18h et Samedi de 10h à  18 h (sauf jours fériés)", //
						"0101-3112_lu+ma+me_14h00-18h00,0101-3112_sa_10h00-18h00,sauf_ferie") //
				.replace(
						...
						"0101-3112_ma+me+ve+sa_09h30-11h30+13h30-16h30,0101-3112_me_13h30-17h30,0101-3112_sa_09h30-11h30+13h30-17h30,") //
				.replace(
						"Ouvert le Lundi de 14h à  19h, du Mardi au Vendredi de 10h à  13h et de 14h à  19h et le samedi de 10h à  13h et de 14h à  18h", //
						"0101-3112_lu_14h00-19h00,0101-3112_ma+me+je+ve_10h00-13h00+14h00-19h00,0101-3112_sa_10h00-13h00+14h00-18h00") //
				.replace("du lundi au samedi de 10h à 18h30", //
						"0101-3112_lu+ma+me+je+ve+sa_10h00-18h30") //
				.replace("Du lundi au vendredi de 9h00 à  18h00.", //
						"0101-3112_lu+ma+me+je+ve_09h00-18h00") //
				.replace(
						"Ouvert le Lundi de 14h à  19h, du Mardi au Vendredi de 9h30 à  12h30 et de 14h à  19h et le samedi de 10h à  12h30 et de 14h à  17h", //
						"0101-3112_lu_14h00-19h00,0101-3112_ma+me+je+ve_09h30-12h30+14h00-19h00,0101-3112_sa_10h00-12h30+14h00-17h00") //
				.replace(
						"Du lundi au vendredi de 9h00 à  12h30 et de 14h00 à  18h00.", //
						"0101-3112_lu+ma+me+je+ve_09h00-12h30+14h00-18h00,") //
				.replace(
						" Été (Du 1er avril au 30 septembre) : Lundi au Vendredi de 10h à 12h15 et de 14h30 à 19h. Samedi de 9h à 12h15 et de 14h30 à 19h. Hiver (du 1er octobre au 31 mars) : Lundi au Samedi de 9h à 12h15 et de 14h30 à 18h. Fermeture les jours fériés.", //
						"0104-3008_lu+ma+me+je+ve_10h00-12h15+14h30-19h00,0104-3008_sa_09h00-12h15+14h30-19h00,0101-3103+0109-3112_lu+ma+me+je+ve+sa_09h00-12h15+14h30-18h00,sauf_ferie") //
				.replace(
						"Boutiques PANNECE - jeudi 14h/17h30 et samedi 9h30/12h30 Boutique BELLIGNE - Lundi 9h/12h et samedi 9h/12h Boutique LE CELLIER - Vendredi 14h/17h et samedi 9h/12h horaires dépots: du mardi au samedi de 9h30 à 12h30 et le jeudi de 14h à 17h30 Possibilité de collecte à domicile", //
						"0101-3112_je_14h00-17h30,0101-3112_sa_09h30-12h30,0101-3112_lu+sa_09h00-12h00,0101-3112_ve_14h00-17h00,0101-3112_sa_09h00-12h00,0101-3112_ma+me+je+ve+sa_09h30-12h30,0101-3112_je_14h00-17h30,") //
				.replace(
						"Ouvert du Lundi au Samedi de 10h à  18h et Dimanche de 8h30 à  12h (sauf jours fériés)", //
						"0101-3112_lu+ma+me+je+sa_10h00-18h00,0101-3112_di_08h30-12h00,,sauf_ferie") //
				.replace(
						"Dépôt d'objets réutilisables : lundi-samedi de 9h à 12h Boutique solidaire : le samedi de 10h à 18h", //
						"0101-3112_lu+ma+me+je+ve_09h00-12h00,0101-3112_sa_10h00-18h00") //
				.replace(
						...
						"0101-3112_lu+ma+me+je+ve+sa+di_00h00-23h59") //
				.replace(
						"du lundi au jeudi de 9h à 12h30 et de 13h30 à 18h et le vendredi à 17h", //
						"0101-3112_lu+ma+me+je_09h00-12h30+13h30-18h00,0101-3112_ve_09h00-12h30+13h30-17h00") //
				.replace(
						"Tous les jours du lundi au vendredi de 9h à 12h et de 14h à 17h", //
						"0101-3112_lu+ma+me+je+ve_09h00-12h00+14h00-17h00") //
				.replace(
						"Ouvert du Mardi au Samedi de 10h à  17h30 (sauf jours fériés)", //
						"0101-3112_ma+me+je+ve+sa_10h00-17h30,sauf_ferie") //
				.replace("Le jeudi de 9h à 12h et de 14h à 17h30 ", //
						"0101-3112_je_09h00-12h00+14h00-17h30"); //
	}
}
